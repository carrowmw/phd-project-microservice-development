...
from dashboard.templates.tables import TabTemplateSingleTable
from dashboard.templates.dataloader_viewer import TabTemplateDataLoaderViewer
from dashboard.templates.dummy import TabTemplateDummy
from dashboard.templates.cards import (
    SensorNameCardTemplate,
    QualityMetricsCardTemplate,
)
from dashboard.templates.map import ContainerTemplateMap, ContainerTemplateMapLegend
from dashboard.templates.dropdown import DropdownTemplate
from dashboard.templates.double_graph import TabTemplateDoubleGraph
from dashboard.data import CustomDashboardData
from dashboard.graphs import PipelineChartCreator, SensorMapCreator
