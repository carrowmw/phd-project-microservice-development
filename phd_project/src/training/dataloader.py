...
from phd_project.src.training.training_datasets import TimeSeriesDataset
from phd_project.src.models import model_definitions
...
def sliding_windows(df: pd.DataFrame, **kwargs) -> Tuple[torch.tensor, torch.tensor]:
    ...
    """
    dataloader_config = load_config("phd_project/configs/dataloader_config.json")
