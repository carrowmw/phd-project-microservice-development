...
from phd_project.src.api import (
    raw_sensor_data_api,
    sensors_api,
    sensor_types_api,
    themes_api,
...
from phd_project.src.utils.pipeline_types import RawDataItem
...
def execute_raw_sensor_data_request(sensors_df: pd.DataFrame) -> List[pd.DataFrame]:
    ...
    ```
    """
    api_config_file_path = "phd_project/configs/api_config.json"
...
def execute_periodic_raw_sensor_data_request(sensors_df: pd.DataFrame) -> list:
    api_config_file_path = "phd_project/configs/api_config.json"
    api_config = load_config(api_config_file_path)
    training_loader_config_path = "phd_project/configs/training_loader_config.json"
