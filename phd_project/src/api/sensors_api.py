...
import json
from phd_project.src.api.api_utils import handle_api_response, make_api_request

# Load the configuration file
with open("phd_project/configs/api_config.json", "r", encoding="utf-8") as config_file:
